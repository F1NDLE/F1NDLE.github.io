...
import { Smartphone, Code, Gamepad, Cpu, User, Zap, Terminal, Heart } from "lucide-react";
  ...
  const sections = [
    {
      ...
      items: [
        ...
        "POCO X4 GT (vendor boot customized, yeeeeeeeah)",
    ...
    },
    {
      ...
      items: [
        ...
        "PC: Arch Linux (main workstation)"
      ]
    },
    {
      ...
      icon: Heart,
      items: [
        "Magisk - systemless modification framework",
        "KernelSU - kernel-level root solution",
        "APatch - next-gen rooting solution",
        "MALW.link - essential tools & services (https://malw.link)"
      ]
    }
  ];

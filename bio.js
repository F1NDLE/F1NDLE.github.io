...
import { Smartphone, Code, Gamepad, Cpu, User, Zap, Terminal, Heart, Link } from "lucide-react";
  ...
  const sections = [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "APatch", url: "https://apatch.org/" },
                ...
                {section.items.map((item, itemIndex) => (
                  ...
                  >
                    ...
                    {typeof item === 'string' ? (
                      ...
                      >
                        {item.text}
                        <Link className="w-3 h-3 ml-1 text-purple-400 group-hover/link:translate-x-1 transition-transform" />
                      </a>
                    )}
                  </motion.li>
                ))}
